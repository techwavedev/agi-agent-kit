...
python3 execution/memory_manager.py auto --query "test patterns and coverage strategies for Tdd Workflows Tdd Refactor"
```
...
python3 execution/memory_manager.py store \
  ...
  --tags tdd-workflows-tdd-refactor testing
```
