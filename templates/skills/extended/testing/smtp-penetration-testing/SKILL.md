...
python3 execution/memory_manager.py auto --query "test patterns and coverage strategies for Smtp Penetration Testing"
```
...
python3 execution/memory_manager.py store \
  ...
  --tags smtp-penetration-testing testing
```
