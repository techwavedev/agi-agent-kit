...
python3 execution/memory_manager.py auto --query "agent patterns and orchestration strategies for Subagent Driven Development"
```
...
python3 execution/memory_manager.py store \
  ...
  --tags subagent-driven-development ai-agents
```
