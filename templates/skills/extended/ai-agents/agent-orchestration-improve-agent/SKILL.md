...
python3 execution/memory_manager.py auto --query "agent patterns and orchestration strategies for Agent Orchestration Improve Agent"
```
...
python3 execution/memory_manager.py store \
  ...
  --tags agent-orchestration-improve-agent ai-agents
```
