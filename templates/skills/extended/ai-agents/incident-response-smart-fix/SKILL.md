...
python3 execution/memory_manager.py auto --query "agent patterns and orchestration strategies for Incident Response Smart Fix"
```
...
python3 execution/memory_manager.py store \
  ...
  --tags incident-response-smart-fix ai-agents
```
