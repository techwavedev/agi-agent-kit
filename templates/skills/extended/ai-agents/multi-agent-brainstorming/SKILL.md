...
python3 execution/memory_manager.py auto --query "agent patterns and orchestration strategies for Multi Agent Brainstorming"
```
...
python3 execution/memory_manager.py store \
  ...
  --tags multi-agent-brainstorming ai-agents
```
