...
python3 execution/memory_manager.py auto --query "agent patterns and orchestration strategies for Llm Application Dev Langchain Agent"
```
...
python3 execution/memory_manager.py store \
  ...
  --tags llm-application-dev-langchain-agent ai-agents
```
