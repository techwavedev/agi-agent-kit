...
python3 execution/memory_manager.py auto --query "agent patterns and orchestration strategies for Azure Ai Openai Dotnet"
```
...
python3 execution/memory_manager.py store \
  ...
  --tags azure-ai-openai-dotnet ai-agents
```
