...
python3 execution/memory_manager.py auto --query "agent patterns and orchestration strategies for Mailchimp Automation"
```
...
python3 execution/memory_manager.py store \
  ...
  --tags mailchimp-automation ai-agents
```
