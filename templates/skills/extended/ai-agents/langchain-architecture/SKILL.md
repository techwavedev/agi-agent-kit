...
python3 execution/memory_manager.py auto --query "agent patterns and orchestration strategies for Langchain Architecture"
```
...
python3 execution/memory_manager.py store \
  ...
  --tags langchain-architecture ai-agents
```
