...
python3 execution/memory_manager.py auto --query "agent patterns and orchestration strategies for Context Fundamentals"
```
...
python3 execution/memory_manager.py store \
  ...
  --tags context-fundamentals ai-agents
```
