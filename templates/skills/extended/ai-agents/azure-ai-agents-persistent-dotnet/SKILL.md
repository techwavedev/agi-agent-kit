...
python3 execution/memory_manager.py auto --query "agent patterns and orchestration strategies for Azure Ai Agents Persistent Dotnet"
```
...
python3 execution/memory_manager.py store \
  ...
  --tags azure-ai-agents-persistent-dotnet ai-agents
```
