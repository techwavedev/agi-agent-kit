...
python3 execution/memory_manager.py auto --query "agent patterns and orchestration strategies for Voice Ai Development"
```
...
python3 execution/memory_manager.py store \
  ...
  --tags voice-ai-development ai-agents
```
