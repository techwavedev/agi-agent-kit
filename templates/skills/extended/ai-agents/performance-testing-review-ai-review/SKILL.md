...
python3 execution/memory_manager.py auto --query "agent patterns and orchestration strategies for Performance Testing Review Ai Review"
```
...
python3 execution/memory_manager.py store \
  ...
  --tags performance-testing-review-ai-review ai-agents
```
