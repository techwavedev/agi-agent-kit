...
python3 execution/memory_manager.py auto --query "agent patterns and orchestration strategies for Computer Vision Expert"
```
...
python3 execution/memory_manager.py store \
  ...
  --tags computer-vision-expert ai-agents
```
