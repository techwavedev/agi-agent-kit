...
python3 execution/memory_manager.py auto --query "agent patterns and orchestration strategies for Azure Ai Voicelive Py"
```
...
python3 execution/memory_manager.py store \
  ...
  --tags azure-ai-voicelive-py ai-agents
```
