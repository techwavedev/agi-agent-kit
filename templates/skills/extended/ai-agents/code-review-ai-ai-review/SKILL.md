...
python3 execution/memory_manager.py auto --query "agent patterns and orchestration strategies for Code Review Ai Ai Review"
```
...
python3 execution/memory_manager.py store \
  ...
  --tags code-review-ai-ai-review ai-agents
```
