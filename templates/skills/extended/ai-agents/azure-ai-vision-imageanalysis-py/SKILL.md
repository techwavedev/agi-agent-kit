...
python3 execution/memory_manager.py auto --query "agent patterns and orchestration strategies for Azure Ai Vision Imageanalysis Py"
```
...
python3 execution/memory_manager.py store \
  ...
  --tags azure-ai-vision-imageanalysis-py ai-agents
```
