...
python3 execution/memory_manager.py auto --query "agent patterns and orchestration strategies for Azure Ai Contentsafety Ts"
```
...
python3 execution/memory_manager.py store \
  ...
  --tags azure-ai-contentsafety-ts ai-agents
```
