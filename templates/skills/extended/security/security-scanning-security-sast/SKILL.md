...
python3 execution/memory_manager.py auto --query "prior security audit results for Security Scanning Security Sast"
```
...
python3 execution/memory_manager.py store \
  ...
  --tags security-scanning-security-sast security
```
