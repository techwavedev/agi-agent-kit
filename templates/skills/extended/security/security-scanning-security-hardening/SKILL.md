...
python3 execution/memory_manager.py auto --query "prior security audit results for Security Scanning Security Hardening"
```
...
python3 execution/memory_manager.py store \
  ...
  --tags security-scanning-security-hardening security
```
