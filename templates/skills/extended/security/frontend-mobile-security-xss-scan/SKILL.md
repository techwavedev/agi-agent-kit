...
python3 execution/memory_manager.py auto --query "prior security audit results for Frontend Mobile Security Xss Scan"
```
...
python3 execution/memory_manager.py store \
  ...
  --tags frontend-mobile-security-xss-scan security
```
