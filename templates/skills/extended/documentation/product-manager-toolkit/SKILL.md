...
python3 execution/memory_manager.py auto --query "documentation patterns and prior content for Product Manager Toolkit"
```
...
python3 execution/memory_manager.py store \
  ...
  --tags product-manager-toolkit documentation
```
