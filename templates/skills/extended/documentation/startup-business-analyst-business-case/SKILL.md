...
python3 execution/memory_manager.py auto --query "documentation patterns and prior content for Startup Business Analyst Business Case"
```
...
python3 execution/memory_manager.py store \
  ...
  --tags startup-business-analyst-business-case documentation
```
