...
python3 execution/memory_manager.py auto --query "documentation patterns and prior content for Defi Protocol Templates"
```
...
python3 execution/memory_manager.py store \
  ...
  --tags defi-protocol-templates documentation
```
