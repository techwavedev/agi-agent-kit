...
python3 execution/memory_manager.py auto --query "documentation patterns and prior content for Api Documentation Generator"
```
...
python3 execution/memory_manager.py store \
  ...
  --tags api-documentation-generator documentation
```
