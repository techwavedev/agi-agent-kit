...
python3 execution/memory_manager.py auto --query "documentation patterns and prior content for Azure Search Documents Ts"
```
...
python3 execution/memory_manager.py store \
  ...
  --tags azure-search-documents-ts documentation
```
