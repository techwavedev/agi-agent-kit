...
python3 execution/memory_manager.py auto --query "API design patterns and architecture decisions for Multi Platform Apps Multi Platform"
```
...
python3 execution/memory_manager.py store \
  ...
  --tags multi-platform-apps-multi-platform backend
```
