...
python3 execution/memory_manager.py auto --query "API design patterns and architecture decisions for Azure Mgmt Apicenter Dotnet"
```
...
python3 execution/memory_manager.py store \
  ...
  --tags azure-mgmt-apicenter-dotnet backend
```
