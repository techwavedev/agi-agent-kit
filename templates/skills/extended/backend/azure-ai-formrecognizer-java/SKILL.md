...
python3 execution/memory_manager.py auto --query "API design patterns and architecture decisions for Azure Ai Formrecognizer Java"
```
...
python3 execution/memory_manager.py store \
  ...
  --tags azure-ai-formrecognizer-java backend
```
