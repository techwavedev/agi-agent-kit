...
python3 execution/memory_manager.py auto --query "API design patterns and architecture decisions for Microsoft Azure Webjobs Extensions Authentication Events Dotnet"
```
...
python3 execution/memory_manager.py store \
  ...
  --tags microsoft-azure-webjobs-extensions-authentication-events-dotnet backend
```
