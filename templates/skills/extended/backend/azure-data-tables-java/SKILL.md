...
python3 execution/memory_manager.py auto --query "API design patterns and architecture decisions for Azure Data Tables Java"
```
...
python3 execution/memory_manager.py store \
  ...
  --tags azure-data-tables-java backend
```
