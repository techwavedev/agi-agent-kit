...
python3 execution/memory_manager.py auto --query "API design patterns and architecture decisions for Backend Development Feature Development"
```
...
python3 execution/memory_manager.py store \
  ...
  --tags backend-development-feature-development backend
```
