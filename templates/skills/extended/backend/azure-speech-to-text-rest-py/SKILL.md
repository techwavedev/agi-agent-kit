...
python3 execution/memory_manager.py auto --query "API design patterns and architecture decisions for Azure Speech To Text Rest Py"
```
...
python3 execution/memory_manager.py store \
  ...
  --tags azure-speech-to-text-rest-py backend
```
