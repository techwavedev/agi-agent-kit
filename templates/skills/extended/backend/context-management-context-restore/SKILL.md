...
python3 execution/memory_manager.py auto --query "API design patterns and architecture decisions for Context Management Context Restore"
```
...
python3 execution/memory_manager.py store \
  ...
  --tags context-management-context-restore backend
```
