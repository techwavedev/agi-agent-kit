...
python3 execution/memory_manager.py auto --query "API design patterns and architecture decisions for Terraform Specialist"
```
...
python3 execution/memory_manager.py store \
  ...
  --tags terraform-specialist backend
```
