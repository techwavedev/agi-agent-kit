...
python3 execution/memory_manager.py auto --query "API design patterns and architecture decisions for Sql Optimization Patterns"
```
...
python3 execution/memory_manager.py store \
  ...
  --tags sql-optimization-patterns backend
```
