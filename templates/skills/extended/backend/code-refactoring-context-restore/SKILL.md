...
python3 execution/memory_manager.py auto --query "API design patterns and architecture decisions for Code Refactoring Context Restore"
```
...
python3 execution/memory_manager.py store \
  ...
  --tags code-refactoring-context-restore backend
```
