...
python3 execution/memory_manager.py auto --query "API design patterns and architecture decisions for Cc Skill Backend Patterns"
```
...
python3 execution/memory_manager.py store \
  ...
  --tags cc-skill-backend-patterns backend
```
