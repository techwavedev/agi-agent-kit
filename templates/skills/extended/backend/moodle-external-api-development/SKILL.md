...
python3 execution/memory_manager.py auto --query "API design patterns and architecture decisions for Moodle External Api Development"
```
...
python3 execution/memory_manager.py store \
  ...
  --tags moodle-external-api-development backend
```
