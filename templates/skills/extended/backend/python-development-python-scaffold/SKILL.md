...
python3 execution/memory_manager.py auto --query "API design patterns and architecture decisions for Python Development Python Scaffold"
```
...
python3 execution/memory_manager.py store \
  ...
  --tags python-development-python-scaffold backend
```
