...
python3 execution/memory_manager.py auto --query "API design patterns and architecture decisions for Azure Resource Manager Redis Dotnet"
```
...
python3 execution/memory_manager.py store \
  ...
  --tags azure-resource-manager-redis-dotnet backend
```
