...
python3 execution/memory_manager.py auto --query "API design patterns and architecture decisions for Broken Authentication"
```
...
python3 execution/memory_manager.py store \
  ...
  --tags broken-authentication backend
```
