...
python3 execution/memory_manager.py auto --query "API design patterns and architecture decisions for Azure Resource Manager Postgresql Dotnet"
```
...
python3 execution/memory_manager.py store \
  ...
  --tags azure-resource-manager-postgresql-dotnet backend
```
