...
python3 execution/memory_manager.py auto --query "API design patterns and architecture decisions for Twilio Communications"
```
...
python3 execution/memory_manager.py store \
  ...
  --tags twilio-communications backend
```
