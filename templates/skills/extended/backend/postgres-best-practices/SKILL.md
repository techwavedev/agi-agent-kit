...
python3 execution/memory_manager.py auto --query "API design patterns and architecture decisions for Postgres Best Practices"
```
...
python3 execution/memory_manager.py store \
  ...
  --tags postgres-best-practices backend
```
