...
python3 execution/memory_manager.py auto --query "API design patterns and architecture decisions for Azure Resource Manager Sql Dotnet"
```
...
python3 execution/memory_manager.py store \
  ...
  --tags azure-resource-manager-sql-dotnet backend
```
