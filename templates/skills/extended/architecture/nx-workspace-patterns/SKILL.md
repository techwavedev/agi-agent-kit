...
python3 execution/memory_manager.py auto --query "architecture decisions and trade-off analysis for Nx Workspace Patterns"
```
...
python3 execution/memory_manager.py store \
  ...
  --tags nx-workspace-patterns architecture
```
