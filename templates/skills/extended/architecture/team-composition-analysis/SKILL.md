...
python3 execution/memory_manager.py auto --query "architecture decisions and trade-off analysis for Team Composition Analysis"
```
...
python3 execution/memory_manager.py store \
  ...
  --tags team-composition-analysis architecture
```
