...
python3 execution/memory_manager.py auto --query "architecture decisions and trade-off analysis for Planning With Files"
```
...
python3 execution/memory_manager.py store \
  ...
  --tags planning-with-files architecture
```
