...
python3 execution/memory_manager.py auto --query "architecture decisions and trade-off analysis for Binary Analysis Patterns"
```
...
python3 execution/memory_manager.py store \
  ...
  --tags binary-analysis-patterns architecture
```
