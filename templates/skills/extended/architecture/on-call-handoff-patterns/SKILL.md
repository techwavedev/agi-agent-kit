...
python3 execution/memory_manager.py auto --query "architecture decisions and trade-off analysis for On Call Handoff Patterns"
```
...
python3 execution/memory_manager.py store \
  ...
  --tags on-call-handoff-patterns architecture
```
