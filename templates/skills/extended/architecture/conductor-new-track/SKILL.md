...
python3 execution/memory_manager.py auto --query "architecture decisions and trade-off analysis for Conductor New Track"
```
...
python3 execution/memory_manager.py store \
  ...
  --tags conductor-new-track architecture
```
