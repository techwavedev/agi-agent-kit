...
python3 execution/memory_manager.py auto --query "deployment configuration and patterns for Database Cloud Optimization Cost Optimize"
```
...
python3 execution/memory_manager.py store \
  ...
  --tags database-cloud-optimization-cost-optimize devops
```
