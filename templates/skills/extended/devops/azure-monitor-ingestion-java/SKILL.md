...
python3 execution/memory_manager.py auto --query "deployment configuration and patterns for Azure Monitor Ingestion Java"
```
...
python3 execution/memory_manager.py store \
  ...
  --tags azure-monitor-ingestion-java devops
```
