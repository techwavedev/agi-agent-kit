...
python3 execution/memory_manager.py auto --query "deployment configuration and patterns for Azure Ai Anomalydetector Java"
```
...
python3 execution/memory_manager.py store \
  ...
  --tags azure-ai-anomalydetector-java devops
```
