...
python3 execution/memory_manager.py auto --query "deployment configuration and patterns for Azure Appconfiguration Java"
```
...
python3 execution/memory_manager.py store \
  ...
  --tags azure-appconfiguration-java devops
```
