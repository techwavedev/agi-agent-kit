...
python3 execution/memory_manager.py auto --query "deployment configuration and patterns for Azure Mgmt Botservice Dotnet"
```
...
python3 execution/memory_manager.py store \
  ...
  --tags azure-mgmt-botservice-dotnet devops
```
