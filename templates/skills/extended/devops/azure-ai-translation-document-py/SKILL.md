...
python3 execution/memory_manager.py auto --query "deployment configuration and patterns for Azure Ai Translation Document Py"
```
...
python3 execution/memory_manager.py store \
  ...
  --tags azure-ai-translation-document-py devops
```
