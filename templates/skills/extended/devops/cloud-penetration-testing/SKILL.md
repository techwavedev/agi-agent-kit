...
python3 execution/memory_manager.py auto --query "deployment configuration and patterns for Cloud Penetration Testing"
```
...
python3 execution/memory_manager.py store \
  ...
  --tags cloud-penetration-testing devops
```
