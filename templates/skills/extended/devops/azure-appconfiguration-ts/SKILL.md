...
python3 execution/memory_manager.py auto --query "deployment configuration and patterns for Azure Appconfiguration Ts"
```
...
python3 execution/memory_manager.py store \
  ...
  --tags azure-appconfiguration-ts devops
```
