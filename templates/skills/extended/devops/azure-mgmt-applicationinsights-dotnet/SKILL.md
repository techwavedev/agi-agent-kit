...
python3 execution/memory_manager.py auto --query "deployment configuration and patterns for Azure Mgmt Applicationinsights Dotnet"
```
...
python3 execution/memory_manager.py store \
  ...
  --tags azure-mgmt-applicationinsights-dotnet devops
```
