...
python3 execution/memory_manager.py auto --query "deployment configuration and patterns for Azure Search Documents Dotnet"
```
...
python3 execution/memory_manager.py store \
  ...
  --tags azure-search-documents-dotnet devops
```
