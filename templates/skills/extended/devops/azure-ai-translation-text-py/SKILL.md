...
python3 execution/memory_manager.py auto --query "deployment configuration and patterns for Azure Ai Translation Text Py"
```
...
python3 execution/memory_manager.py store \
  ...
  --tags azure-ai-translation-text-py devops
```
