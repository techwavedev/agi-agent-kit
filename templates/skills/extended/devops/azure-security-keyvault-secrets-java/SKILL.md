...
python3 execution/memory_manager.py auto --query "deployment configuration and patterns for Azure Security Keyvault Secrets Java"
```
...
python3 execution/memory_manager.py store \
  ...
  --tags azure-security-keyvault-secrets-java devops
```
