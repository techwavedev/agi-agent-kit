...
python3 execution/memory_manager.py auto --query "deployment configuration and patterns for Full Stack Orchestration Full Stack Feature"
```
...
python3 execution/memory_manager.py store \
  ...
  --tags full-stack-orchestration-full-stack-feature devops
```
