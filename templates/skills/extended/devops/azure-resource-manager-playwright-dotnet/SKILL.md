...
python3 execution/memory_manager.py auto --query "deployment configuration and patterns for Azure Resource Manager Playwright Dotnet"
```
...
python3 execution/memory_manager.py store \
  ...
  --tags azure-resource-manager-playwright-dotnet devops
```
