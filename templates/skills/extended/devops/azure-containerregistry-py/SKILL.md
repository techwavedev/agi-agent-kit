...
python3 execution/memory_manager.py auto --query "deployment configuration and patterns for Azure Containerregistry Py"
```
...
python3 execution/memory_manager.py store \
  ...
  --tags azure-containerregistry-py devops
```
