...
python3 execution/memory_manager.py auto --query "deployment configuration and patterns for Windows Privilege Escalation"
```
...
python3 execution/memory_manager.py store \
  ...
  --tags windows-privilege-escalation devops
```
