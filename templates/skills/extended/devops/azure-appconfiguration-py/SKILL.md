...
python3 execution/memory_manager.py auto --query "deployment configuration and patterns for Azure Appconfiguration Py"
```
...
python3 execution/memory_manager.py store \
  ...
  --tags azure-appconfiguration-py devops
```
