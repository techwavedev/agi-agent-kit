...
python3 execution/memory_manager.py auto --query "deployment configuration and patterns for Azure Ai Voicelive Dotnet"
```
...
python3 execution/memory_manager.py store \
  ...
  --tags azure-ai-voicelive-dotnet devops
```
