...
python3 execution/memory_manager.py auto --query "deployment configuration and patterns for Azure Communication Sms Java"
```
...
python3 execution/memory_manager.py store \
  ...
  --tags azure-communication-sms-java devops
```
