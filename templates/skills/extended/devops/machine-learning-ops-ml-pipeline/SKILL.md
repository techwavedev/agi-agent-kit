...
python3 execution/memory_manager.py auto --query "deployment configuration and patterns for Machine Learning Ops Ml Pipeline"
```
...
python3 execution/memory_manager.py store \
  ...
  --tags machine-learning-ops-ml-pipeline devops
```
