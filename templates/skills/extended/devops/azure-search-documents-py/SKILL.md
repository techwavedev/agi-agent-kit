...
python3 execution/memory_manager.py auto --query "deployment configuration and patterns for Azure Search Documents Py"
```
...
python3 execution/memory_manager.py store \
  ...
  --tags azure-search-documents-py devops
```
