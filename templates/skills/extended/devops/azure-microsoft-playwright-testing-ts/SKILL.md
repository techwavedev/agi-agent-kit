...
python3 execution/memory_manager.py auto --query "deployment configuration and patterns for Azure Microsoft Playwright Testing Ts"
```
...
python3 execution/memory_manager.py store \
  ...
  --tags azure-microsoft-playwright-testing-ts devops
```
