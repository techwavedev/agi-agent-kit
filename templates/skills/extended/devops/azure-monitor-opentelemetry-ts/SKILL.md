...
python3 execution/memory_manager.py auto --query "deployment configuration and patterns for Azure Monitor Opentelemetry Ts"
```
...
python3 execution/memory_manager.py store \
  ...
  --tags azure-monitor-opentelemetry-ts devops
```
