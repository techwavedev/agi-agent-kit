...
python3 execution/memory_manager.py auto --query "deployment configuration and patterns for Azure Monitor Ingestion Py"
```
...
python3 execution/memory_manager.py store \
  ...
  --tags azure-monitor-ingestion-py devops
```
