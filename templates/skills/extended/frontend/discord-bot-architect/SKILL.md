...
python3 execution/memory_manager.py auto --query "design system decisions and component patterns for Discord Bot Architect"
```
...
python3 execution/memory_manager.py store \
  ...
  --tags discord-bot-architect frontend
```
