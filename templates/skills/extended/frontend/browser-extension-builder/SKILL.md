...
python3 execution/memory_manager.py auto --query "design system decisions and component patterns for Browser Extension Builder"
```
...
python3 execution/memory_manager.py store \
  ...
  --tags browser-extension-builder frontend
```
