...
python3 execution/memory_manager.py auto --query "design system decisions and component patterns for Telegram Bot Builder"
```
...
python3 execution/memory_manager.py store \
  ...
  --tags telegram-bot-builder frontend
```
