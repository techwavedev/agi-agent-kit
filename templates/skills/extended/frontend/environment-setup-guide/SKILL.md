...
python3 execution/memory_manager.py auto --query "design system decisions and component patterns for Environment Setup Guide"
```
...
python3 execution/memory_manager.py store \
  ...
  --tags environment-setup-guide frontend
```
