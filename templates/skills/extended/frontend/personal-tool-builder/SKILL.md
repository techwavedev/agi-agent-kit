...
python3 execution/memory_manager.py auto --query "design system decisions and component patterns for Personal Tool Builder"
```
...
python3 execution/memory_manager.py store \
  ...
  --tags personal-tool-builder frontend
```
