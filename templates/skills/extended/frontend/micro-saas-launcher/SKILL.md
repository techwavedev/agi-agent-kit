...
python3 execution/memory_manager.py auto --query "design system decisions and component patterns for Micro Saas Launcher"
```
...
python3 execution/memory_manager.py store \
  ...
  --tags micro-saas-launcher frontend
```
