...
python3 execution/memory_manager.py auto --query "design system decisions and component patterns for Linux Privilege Escalation"
```
...
python3 execution/memory_manager.py store \
  ...
  --tags linux-privilege-escalation frontend
```
