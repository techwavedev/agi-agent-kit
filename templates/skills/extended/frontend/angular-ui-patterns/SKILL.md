...
python3 execution/memory_manager.py auto --query "design system decisions and component patterns for Angular Ui Patterns"
```
...
python3 execution/memory_manager.py store \
  ...
  --tags angular-ui-patterns frontend
```
