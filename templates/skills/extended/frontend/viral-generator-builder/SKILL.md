...
python3 execution/memory_manager.py auto --query "design system decisions and component patterns for Viral Generator Builder"
```
...
python3 execution/memory_manager.py store \
  ...
  --tags viral-generator-builder frontend
```
