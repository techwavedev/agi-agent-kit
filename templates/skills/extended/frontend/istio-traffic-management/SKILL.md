...
python3 execution/memory_manager.py auto --query "design system decisions and component patterns for Istio Traffic Management"
```
...
python3 execution/memory_manager.py store \
  ...
  --tags istio-traffic-management frontend
```
