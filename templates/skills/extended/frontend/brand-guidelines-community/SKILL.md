...
python3 execution/memory_manager.py auto --query "design system decisions and component patterns for Brand Guidelines Community"
```
...
python3 execution/memory_manager.py store \
  ...
  --tags brand-guidelines-community frontend
```
