...
python3 execution/memory_manager.py auto --query "design system decisions and component patterns for Html Injection Testing"
```
...
python3 execution/memory_manager.py store \
  ...
  --tags html-injection-testing frontend
```
