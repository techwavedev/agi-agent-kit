...
python3 execution/memory_manager.py auto --query "design system decisions and component patterns for React Flow Architect"
```
...
python3 execution/memory_manager.py store \
  ...
  --tags react-flow-architect frontend
```
