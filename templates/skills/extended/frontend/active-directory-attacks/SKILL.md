...
python3 execution/memory_manager.py auto --query "design system decisions and component patterns for Active Directory Attacks"
```
...
python3 execution/memory_manager.py store \
  ...
  --tags active-directory-attacks frontend
```
