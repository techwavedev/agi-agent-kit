...
python3 execution/memory_manager.py auto --query "design system decisions and component patterns for Ui Visual Validator"
```
...
python3 execution/memory_manager.py store \
  ...
  --tags ui-visual-validator frontend
```
