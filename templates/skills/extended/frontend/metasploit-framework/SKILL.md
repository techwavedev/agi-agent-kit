...
python3 execution/memory_manager.py auto --query "design system decisions and component patterns for Metasploit Framework"
```
...
python3 execution/memory_manager.py store \
  ...
  --tags metasploit-framework frontend
```
