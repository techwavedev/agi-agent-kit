...
python3 execution/memory_manager.py auto --query "design system decisions and component patterns for Frontend Ui Dark Ts"
```
...
python3 execution/memory_manager.py store \
  ...
  --tags frontend-ui-dark-ts frontend
```
