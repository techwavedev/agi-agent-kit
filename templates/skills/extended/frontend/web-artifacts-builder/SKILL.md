...
python3 execution/memory_manager.py auto --query "design system decisions and component patterns for Web Artifacts Builder"
```
...
python3 execution/memory_manager.py store \
  ...
  --tags web-artifacts-builder frontend
```
