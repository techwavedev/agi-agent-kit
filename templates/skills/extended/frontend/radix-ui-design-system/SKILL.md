...
python3 execution/memory_manager.py auto --query "design system decisions and component patterns for Radix Ui Design System"
```
...
python3 execution/memory_manager.py store \
  ...
  --tags radix-ui-design-system frontend
```
