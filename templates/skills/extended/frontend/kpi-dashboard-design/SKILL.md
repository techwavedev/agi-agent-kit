...
python3 execution/memory_manager.py auto --query "design system decisions and component patterns for Kpi Dashboard Design"
```
...
python3 execution/memory_manager.py store \
  ...
  --tags kpi-dashboard-design frontend
```
