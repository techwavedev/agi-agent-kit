...
python3 execution/memory_manager.py auto --query "design system decisions and component patterns for Frontend Mobile Development Component Scaffold"
```
...
python3 execution/memory_manager.py store \
  ...
  --tags frontend-mobile-development-component-scaffold frontend
```
