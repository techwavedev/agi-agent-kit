...
python3 execution/memory_manager.py auto --query "design system decisions and component patterns for Risk Metrics Calculation"
```
...
python3 execution/memory_manager.py store \
  ...
  --tags risk-metrics-calculation frontend
```
