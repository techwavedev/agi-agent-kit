...
python3 execution/memory_manager.py auto --query "error patterns and debugging solutions for Debugging Toolkit Smart Debug"
```
...
python3 execution/memory_manager.py store \
  ...
  --tags debugging-toolkit-smart-debug debugging
```
