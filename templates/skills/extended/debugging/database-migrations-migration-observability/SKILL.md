...
python3 execution/memory_manager.py auto --query "error patterns and debugging solutions for Database Migrations Migration Observability"
```
...
python3 execution/memory_manager.py store \
  ...
  --tags database-migrations-migration-observability debugging
```
