...
python3 execution/memory_manager.py auto --query "error patterns and debugging solutions for Web Performance Optimization"
```
...
python3 execution/memory_manager.py store \
  ...
  --tags web-performance-optimization debugging
```
