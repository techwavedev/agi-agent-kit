...
python3 execution/memory_manager.py auto --query "error patterns and debugging solutions for Codebase Cleanup Tech Debt"
```
...
python3 execution/memory_manager.py store \
  ...
  --tags codebase-cleanup-tech-debt debugging
```
