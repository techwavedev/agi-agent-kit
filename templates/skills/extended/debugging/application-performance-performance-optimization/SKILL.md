...
python3 execution/memory_manager.py auto --query "error patterns and debugging solutions for Application Performance Performance Optimization"
```
...
python3 execution/memory_manager.py store \
  ...
  --tags application-performance-performance-optimization debugging
```
