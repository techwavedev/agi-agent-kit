...
python3 execution/memory_manager.py auto --query "error patterns and debugging solutions for Error Debugging Multi Agent Review"
```
...
python3 execution/memory_manager.py store \
  ...
  --tags error-debugging-multi-agent-review debugging
```
