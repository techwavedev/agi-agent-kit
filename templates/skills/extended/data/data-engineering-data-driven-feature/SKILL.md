...
python3 execution/memory_manager.py auto --query "data processing patterns and pipeline configurations for Data Engineering Data Driven Feature"
```
...
python3 execution/memory_manager.py store \
  ...
  --tags data-engineering-data-driven-feature data
```
