...
python3 execution/memory_manager.py auto --query "documentation patterns and prior content for Sred Project Organizer"
```
...
python3 execution/memory_manager.py store \
  ...
  --tags sred-project-organizer documentation
```
