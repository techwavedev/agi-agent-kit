...
python3 execution/memory_manager.py auto --query "design system decisions and component patterns for Apify Lead Generation"
```
...
python3 execution/memory_manager.py store \
  ...
  --tags apify-lead-generation frontend
```
