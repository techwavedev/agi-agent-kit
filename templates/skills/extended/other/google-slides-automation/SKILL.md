...
python3 execution/memory_manager.py auto --query "automation patterns and workflow configurations for Google Slides Automation"
```
...
python3 execution/memory_manager.py store \
  ...
  --tags google-slides-automation workflow
```
