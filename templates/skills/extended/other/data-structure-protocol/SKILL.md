...
python3 execution/memory_manager.py auto --query "API design patterns and architecture decisions for Data Structure Protocol"
```
...
python3 execution/memory_manager.py store \
  ...
  --tags data-structure-protocol backend
```
