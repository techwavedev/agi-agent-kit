...
python3 execution/memory_manager.py auto --query "design system decisions and component patterns for Shader Programming Glsl"
```
...
python3 execution/memory_manager.py store \
  ...
  --tags shader-programming-glsl frontend
```
