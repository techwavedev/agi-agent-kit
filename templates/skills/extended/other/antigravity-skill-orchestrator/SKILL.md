...
python3 execution/memory_manager.py auto --query "design system decisions and component patterns for Antigravity Skill Orchestrator"
```
...
python3 execution/memory_manager.py store \
  ...
  --tags antigravity-skill-orchestrator frontend
```
