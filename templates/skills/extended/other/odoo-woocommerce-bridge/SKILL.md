...
python3 execution/memory_manager.py auto --query "API design patterns and architecture decisions for Odoo Woocommerce Bridge"
```
...
python3 execution/memory_manager.py store \
  ...
  --tags odoo-woocommerce-bridge backend
```
