...
python3 execution/memory_manager.py auto --query "design system decisions and component patterns for Odoo Migration Helper"
```
...
python3 execution/memory_manager.py store \
  ...
  --tags odoo-migration-helper frontend
```
