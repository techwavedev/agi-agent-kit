...
python3 execution/memory_manager.py auto --query "API design patterns and architecture decisions for Hugging Face Dataset Viewer"
```
...
python3 execution/memory_manager.py store \
  ...
  --tags hugging-face-dataset-viewer backend
```
