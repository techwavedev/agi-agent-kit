...
python3 execution/memory_manager.py auto --query "design system decisions and component patterns for Odoo Ecommerce Configurator"
```
...
python3 execution/memory_manager.py store \
  ...
  --tags odoo-ecommerce-configurator frontend
```
