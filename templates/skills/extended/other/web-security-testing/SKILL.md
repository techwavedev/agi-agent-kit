...
python3 execution/memory_manager.py auto --query "automation patterns and workflow configurations for Web Security Testing"
```
...
python3 execution/memory_manager.py store \
  ...
  --tags web-security-testing workflow
```
