...
python3 execution/memory_manager.py auto --query "prior work and patterns related to Occupational Health Analyzer"
```
...
python3 execution/memory_manager.py store \
  ...
  --tags occupational-health-analyzer default
```
