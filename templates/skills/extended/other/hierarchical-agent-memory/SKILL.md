...
python3 execution/memory_manager.py auto --query "agent patterns and orchestration strategies for Hierarchical Agent Memory"
```
...
python3 execution/memory_manager.py store \
  ...
  --tags hierarchical-agent-memory ai-agents
```
