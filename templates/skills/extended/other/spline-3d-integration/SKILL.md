...
python3 execution/memory_manager.py auto --query "design system decisions and component patterns for Spline 3D Integration"
```
...
python3 execution/memory_manager.py store \
  ...
  --tags spline-3d-integration frontend
```
