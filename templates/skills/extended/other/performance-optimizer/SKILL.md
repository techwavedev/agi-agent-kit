...
python3 execution/memory_manager.py auto --query "API design patterns and architecture decisions for Performance Optimizer"
```
...
python3 execution/memory_manager.py store \
  ...
  --tags performance-optimizer backend
```
