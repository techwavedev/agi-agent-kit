...
python3 execution/memory_manager.py auto --query "design system decisions and component patterns for Leiloeiro Avaliacao"
```
...
python3 execution/memory_manager.py store \
  ...
  --tags leiloeiro-avaliacao frontend
```
