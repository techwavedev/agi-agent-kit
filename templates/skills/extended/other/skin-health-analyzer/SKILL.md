...
python3 execution/memory_manager.py auto --query "data processing patterns and pipeline configurations for Skin Health Analyzer"
```
...
python3 execution/memory_manager.py store \
  ...
  --tags skin-health-analyzer data
```
