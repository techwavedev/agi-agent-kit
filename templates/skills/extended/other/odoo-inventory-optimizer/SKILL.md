...
python3 execution/memory_manager.py auto --query "design system decisions and component patterns for Odoo Inventory Optimizer"
```
...
python3 execution/memory_manager.py store \
  ...
  --tags odoo-inventory-optimizer frontend
```
