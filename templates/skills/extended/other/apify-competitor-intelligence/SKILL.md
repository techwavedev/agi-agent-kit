...
python3 execution/memory_manager.py auto --query "API design patterns and architecture decisions for Apify Competitor Intelligence"
```
...
python3 execution/memory_manager.py store \
  ...
  --tags apify-competitor-intelligence backend
```
