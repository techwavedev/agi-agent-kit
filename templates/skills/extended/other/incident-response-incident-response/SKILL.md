...
python3 execution/memory_manager.py auto --query "prior work and patterns related to Incident Response Incident Response"
```
...
python3 execution/memory_manager.py store \
  ...
  --tags incident-response-incident-response default
```
