...
python3 execution/memory_manager.py auto --query "design system decisions and component patterns for Odoo Hr Payroll Setup"
```
...
python3 execution/memory_manager.py store \
  ...
  --tags odoo-hr-payroll-setup frontend
```
