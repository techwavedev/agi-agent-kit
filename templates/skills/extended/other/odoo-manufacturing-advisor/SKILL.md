...
python3 execution/memory_manager.py auto --query "design system decisions and component patterns for Odoo Manufacturing Advisor"
```
...
python3 execution/memory_manager.py store \
  ...
  --tags odoo-manufacturing-advisor frontend
```
