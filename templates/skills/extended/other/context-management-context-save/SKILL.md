...
python3 execution/memory_manager.py auto --query "prior work and patterns related to Context Management Context Save"
```
...
python3 execution/memory_manager.py store \
  ...
  --tags context-management-context-save default
```
