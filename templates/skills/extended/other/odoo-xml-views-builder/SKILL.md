...
python3 execution/memory_manager.py auto --query "design system decisions and component patterns for Odoo Xml Views Builder"
```
...
python3 execution/memory_manager.py store \
  ...
  --tags odoo-xml-views-builder frontend
```
