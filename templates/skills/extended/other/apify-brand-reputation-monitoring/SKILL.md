...
python3 execution/memory_manager.py auto --query "API design patterns and architecture decisions for Apify Brand Reputation Monitoring"
```
...
python3 execution/memory_manager.py store \
  ...
  --tags apify-brand-reputation-monitoring backend
```
