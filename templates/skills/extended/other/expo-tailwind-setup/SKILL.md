...
python3 execution/memory_manager.py auto --query "design system decisions and component patterns for Expo Tailwind Setup"
```
...
python3 execution/memory_manager.py store \
  ...
  --tags expo-tailwind-setup frontend
```
