...
python3 execution/memory_manager.py auto --query "design system decisions and component patterns for Odoo Performance Tuner"
```
...
python3 execution/memory_manager.py store \
  ...
  --tags odoo-performance-tuner frontend
```
