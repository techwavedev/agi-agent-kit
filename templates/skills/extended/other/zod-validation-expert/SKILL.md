...
python3 execution/memory_manager.py auto --query "design system decisions and component patterns for Zod Validation Expert"
```
...
python3 execution/memory_manager.py store \
  ...
  --tags zod-validation-expert frontend
```
