...
python3 execution/memory_manager.py auto --query "API design patterns and architecture decisions for Apify Market Research"
```
...
python3 execution/memory_manager.py store \
  ...
  --tags apify-market-research backend
```
