...
python3 execution/memory_manager.py auto --query "design system decisions and component patterns for Shopify Development"
```
...
python3 execution/memory_manager.py store \
  ...
  --tags shopify-development frontend
```
