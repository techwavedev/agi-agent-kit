...
python3 execution/memory_manager.py auto --query "data processing patterns and pipeline configurations for Hugging Face Paper Publisher"
```
...
python3 execution/memory_manager.py store \
  ...
  --tags hugging-face-paper-publisher data
```
