...
python3 execution/memory_manager.py auto --query "error patterns and debugging solutions for Claude In Chrome Troubleshooting"
```
...
python3 execution/memory_manager.py store \
  ...
  --tags claude-in-chrome-troubleshooting debugging
```
