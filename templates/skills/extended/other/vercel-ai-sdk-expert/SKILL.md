...
python3 execution/memory_manager.py auto --query "design system decisions and component patterns for Vercel Ai Sdk Expert"
```
...
python3 execution/memory_manager.py store \
  ...
  --tags vercel-ai-sdk-expert frontend
```
