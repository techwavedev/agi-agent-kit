...
python3 execution/memory_manager.py auto --query "design system decisions and component patterns for N8N Workflow Patterns"
```
...
python3 execution/memory_manager.py store \
  ...
  --tags n8n-workflow-patterns frontend
```
