...
python3 execution/memory_manager.py auto --query "design system decisions and component patterns for Native Data Fetching"
```
...
python3 execution/memory_manager.py store \
  ...
  --tags native-data-fetching frontend
```
