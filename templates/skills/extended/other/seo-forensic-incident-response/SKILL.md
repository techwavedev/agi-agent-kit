...
python3 execution/memory_manager.py auto --query "prior work and patterns related to Seo Forensic Incident Response"
```
...
python3 execution/memory_manager.py store \
  ...
  --tags seo-forensic-incident-response default
```
