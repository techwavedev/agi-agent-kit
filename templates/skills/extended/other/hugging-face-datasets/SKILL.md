...
python3 execution/memory_manager.py auto --query "design system decisions and component patterns for Hugging Face Datasets"
```
...
python3 execution/memory_manager.py store \
  ...
  --tags hugging-face-datasets frontend
```
