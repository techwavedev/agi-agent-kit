...
python3 execution/memory_manager.py auto --query "API design patterns and architecture decisions for Apify Content Analytics"
```
...
python3 execution/memory_manager.py store \
  ...
  --tags apify-content-analytics backend
```
