...
python3 execution/memory_manager.py auto --query "prior work and patterns related to Carrier Relationship Management"
```
...
python3 execution/memory_manager.py store \
  ...
  --tags carrier-relationship-management default
```
