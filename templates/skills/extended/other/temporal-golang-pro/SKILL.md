...
python3 execution/memory_manager.py auto --query "design system decisions and component patterns for Temporal Golang Pro"
```
...
python3 execution/memory_manager.py store \
  ...
  --tags temporal-golang-pro frontend
```
