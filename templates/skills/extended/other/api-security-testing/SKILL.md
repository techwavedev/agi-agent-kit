...
python3 execution/memory_manager.py auto --query "automation patterns and workflow configurations for Api Security Testing"
```
...
python3 execution/memory_manager.py store \
  ...
  --tags api-security-testing workflow
```
