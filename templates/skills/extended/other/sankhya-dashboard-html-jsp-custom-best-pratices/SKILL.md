...
python3 execution/memory_manager.py auto --query "prior work and patterns related to Sankhya Dashboard Html Jsp Custom Best Pratices"
```
...
python3 execution/memory_manager.py store \
  ...
  --tags sankhya-dashboard-html-jsp-custom-best-pratices default
```
