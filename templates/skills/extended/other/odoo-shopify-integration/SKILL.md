...
python3 execution/memory_manager.py auto --query "API design patterns and architecture decisions for Odoo Shopify Integration"
```
...
python3 execution/memory_manager.py store \
  ...
  --tags odoo-shopify-integration backend
```
