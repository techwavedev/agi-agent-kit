...
python3 execution/memory_manager.py auto --query "mobile architecture and platform-specific patterns for Social Orchestrator"
```
...
python3 execution/memory_manager.py store \
  ...
  --tags social-orchestrator mobile
```
