...
python3 execution/memory_manager.py auto --query "prior work and patterns related to Logistics Exception Management"
```
...
python3 execution/memory_manager.py store \
  ...
  --tags logistics-exception-management default
```
