...
python3 execution/memory_manager.py auto --query "architecture decisions and trade-off analysis for Robius App Architecture"
```
...
python3 execution/memory_manager.py store \
  ...
  --tags robius-app-architecture architecture
```
