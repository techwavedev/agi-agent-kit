...
python3 execution/memory_manager.py auto --query "design system decisions and component patterns for Hig Components Layout"
```
...
python3 execution/memory_manager.py store \
  ...
  --tags hig-components-layout frontend
```
