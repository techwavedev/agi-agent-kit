...
python3 execution/memory_manager.py auto --query "API design patterns and architecture decisions for Apify Audience Analysis"
```
...
python3 execution/memory_manager.py store \
  ...
  --tags apify-audience-analysis backend
```
