...
python3 execution/memory_manager.py auto --query "design system decisions and component patterns for Hig Project Context"
```
...
python3 execution/memory_manager.py store \
  ...
  --tags hig-project-context frontend
```
