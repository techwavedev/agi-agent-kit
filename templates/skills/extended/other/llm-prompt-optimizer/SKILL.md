...
python3 execution/memory_manager.py auto --query "agent patterns and orchestration strategies for Llm Prompt Optimizer"
```
...
python3 execution/memory_manager.py store \
  ...
  --tags llm-prompt-optimizer ai-agents
```
