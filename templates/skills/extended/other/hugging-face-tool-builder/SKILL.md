...
python3 execution/memory_manager.py auto --query "design system decisions and component patterns for Hugging Face Tool Builder"
```
...
python3 execution/memory_manager.py store \
  ...
  --tags hugging-face-tool-builder frontend
```
