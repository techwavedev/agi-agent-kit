...
python3 execution/memory_manager.py auto --query "design system decisions and component patterns for N8N Validation Expert"
```
...
python3 execution/memory_manager.py store \
  ...
  --tags n8n-validation-expert frontend
```
