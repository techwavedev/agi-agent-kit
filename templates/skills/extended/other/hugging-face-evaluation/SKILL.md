...
python3 execution/memory_manager.py auto --query "API design patterns and architecture decisions for Hugging Face Evaluation"
```
...
python3 execution/memory_manager.py store \
  ...
  --tags hugging-face-evaluation backend
```
