...
python3 execution/memory_manager.py auto --query "API design patterns and architecture decisions for Emblemai Crypto Wallet"
```
...
python3 execution/memory_manager.py store \
  ...
  --tags emblemai-crypto-wallet backend
```
