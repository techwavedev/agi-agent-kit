...
python3 execution/memory_manager.py auto --query "design system decisions and component patterns for Odoo Accounting Setup"
```
...
python3 execution/memory_manager.py store \
  ...
  --tags odoo-accounting-setup frontend
```
