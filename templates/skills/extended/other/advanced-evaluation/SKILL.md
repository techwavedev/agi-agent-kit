...
python3 execution/memory_manager.py auto --query "automation patterns and workflow configurations for Advanced Evaluation"
```
...
python3 execution/memory_manager.py store \
  ...
  --tags advanced-evaluation workflow
```
