...
python3 execution/memory_manager.py auto --query "design system decisions and component patterns for Android Jetpack Compose Expert"
```
...
python3 execution/memory_manager.py store \
  ...
  --tags android-jetpack-compose-expert frontend
```
