...
python3 execution/memory_manager.py auto --query "design system decisions and component patterns for Tanstack Query Expert"
```
...
python3 execution/memory_manager.py store \
  ...
  --tags tanstack-query-expert frontend
```
