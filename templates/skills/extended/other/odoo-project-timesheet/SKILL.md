...
python3 execution/memory_manager.py auto --query "design system decisions and component patterns for Odoo Project Timesheet"
```
...
python3 execution/memory_manager.py store \
  ...
  --tags odoo-project-timesheet frontend
```
