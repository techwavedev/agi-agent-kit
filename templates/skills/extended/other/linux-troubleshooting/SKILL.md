...
python3 execution/memory_manager.py auto --query "automation patterns and workflow configurations for Linux Troubleshooting"
```
...
python3 execution/memory_manager.py store \
  ...
  --tags linux-troubleshooting workflow
```
