...
python3 execution/memory_manager.py auto --query "test patterns and coverage strategies for Semgrep Rule Variant Creator"
```
...
python3 execution/memory_manager.py store \
  ...
  --tags semgrep-rule-variant-creator testing
```
