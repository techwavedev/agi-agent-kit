...
python3 execution/memory_manager.py auto --query "design system decisions and component patterns for Startup Financial Modeling"
```
...
python3 execution/memory_manager.py store \
  ...
  --tags startup-financial-modeling frontend
```
