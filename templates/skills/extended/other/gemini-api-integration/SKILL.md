...
python3 execution/memory_manager.py auto --query "API design patterns and architecture decisions for Gemini Api Integration"
```
...
python3 execution/memory_manager.py store \
  ...
  --tags gemini-api-integration backend
```
