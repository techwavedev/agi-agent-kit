...
python3 execution/memory_manager.py auto --query "automation patterns and workflow configurations for React Nextjs Development"
```
...
python3 execution/memory_manager.py store \
  ...
  --tags react-nextjs-development workflow
```
