...
python3 execution/memory_manager.py auto --query "game architecture and engine patterns for Startup Business Analyst Market Opportunity"
```
...
python3 execution/memory_manager.py store \
  ...
  --tags startup-business-analyst-market-opportunity gaming
```
