...
python3 execution/memory_manager.py auto --query "automation patterns and workflow configurations for Remotion Best Practices"
```
...
python3 execution/memory_manager.py store \
  ...
  --tags remotion-best-practices workflow
```
