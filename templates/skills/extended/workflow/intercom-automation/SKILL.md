...
python3 execution/memory_manager.py auto --query "automation patterns and workflow configurations for Intercom Automation"
```
...
python3 execution/memory_manager.py store \
  ...
  --tags intercom-automation workflow
```
