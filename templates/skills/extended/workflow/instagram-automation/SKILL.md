...
python3 execution/memory_manager.py auto --query "automation patterns and workflow configurations for Instagram Automation"
```
...
python3 execution/memory_manager.py store \
  ...
  --tags instagram-automation workflow
```
