...
python3 execution/memory_manager.py auto --query "automation patterns and workflow configurations for Git Pr Workflows Git Workflow"
```
...
python3 execution/memory_manager.py store \
  ...
  --tags git-pr-workflows-git-workflow workflow
```
