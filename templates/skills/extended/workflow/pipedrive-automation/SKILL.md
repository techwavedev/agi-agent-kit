...
python3 execution/memory_manager.py auto --query "automation patterns and workflow configurations for Pipedrive Automation"
```
...
python3 execution/memory_manager.py store \
  ...
  --tags pipedrive-automation workflow
```
