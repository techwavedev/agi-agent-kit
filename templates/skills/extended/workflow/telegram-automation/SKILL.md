...
python3 execution/memory_manager.py auto --query "automation patterns and workflow configurations for Telegram Automation"
```
...
python3 execution/memory_manager.py store \
  ...
  --tags telegram-automation workflow
```
