...
python3 execution/memory_manager.py auto --query "automation patterns and workflow configurations for Calendly Automation"
```
...
python3 execution/memory_manager.py store \
  ...
  --tags calendly-automation workflow
```
