...
python3 execution/memory_manager.py auto --query "automation patterns and workflow configurations for Startup Business Analyst Financial Projections"
```
...
python3 execution/memory_manager.py store \
  ...
  --tags startup-business-analyst-financial-projections workflow
```
