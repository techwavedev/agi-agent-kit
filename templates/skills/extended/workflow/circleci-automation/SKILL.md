...
python3 execution/memory_manager.py auto --query "automation patterns and workflow configurations for Circleci Automation"
```
...
python3 execution/memory_manager.py store \
  ...
  --tags circleci-automation workflow
```
