...
python3 execution/memory_manager.py auto --query "automation patterns and workflow configurations for Git Pr Workflows Onboard"
```
...
python3 execution/memory_manager.py store \
  ...
  --tags git-pr-workflows-onboard workflow
```
