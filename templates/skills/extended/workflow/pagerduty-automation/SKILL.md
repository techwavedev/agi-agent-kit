...
python3 execution/memory_manager.py auto --query "automation patterns and workflow configurations for Pagerduty Automation"
```
...
python3 execution/memory_manager.py store \
  ...
  --tags pagerduty-automation workflow
```
