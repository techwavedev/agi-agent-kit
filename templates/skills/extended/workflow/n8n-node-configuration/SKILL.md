...
python3 execution/memory_manager.py auto --query "automation patterns and workflow configurations for N8N Node Configuration"
```
...
python3 execution/memory_manager.py store \
  ...
  --tags n8n-node-configuration workflow
```
