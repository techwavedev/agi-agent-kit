...
python3 execution/memory_manager.py auto --query "automation patterns and workflow configurations for Convertkit Automation"
```
...
python3 execution/memory_manager.py store \
  ...
  --tags convertkit-automation workflow
```
