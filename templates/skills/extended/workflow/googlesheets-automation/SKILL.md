...
python3 execution/memory_manager.py auto --query "automation patterns and workflow configurations for Googlesheets Automation"
```
...
python3 execution/memory_manager.py store \
  ...
  --tags googlesheets-automation workflow
```
