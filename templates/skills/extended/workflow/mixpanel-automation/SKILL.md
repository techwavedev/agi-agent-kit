...
python3 execution/memory_manager.py auto --query "automation patterns and workflow configurations for Mixpanel Automation"
```
...
python3 execution/memory_manager.py store \
  ...
  --tags mixpanel-automation workflow
```
