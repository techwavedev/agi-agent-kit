...
python3 execution/memory_manager.py auto --query "automation patterns and workflow configurations for Systems Programming Rust Project"
```
...
python3 execution/memory_manager.py store \
  ...
  --tags systems-programming-rust-project workflow
```
