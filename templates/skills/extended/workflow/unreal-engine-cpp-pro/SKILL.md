...
python3 execution/memory_manager.py auto --query "automation patterns and workflow configurations for Unreal Engine Cpp Pro"
```
...
python3 execution/memory_manager.py store \
  ...
  --tags unreal-engine-cpp-pro workflow
```
