...
python3 execution/memory_manager.py auto --query "automation patterns and workflow configurations for Outlook Calendar Automation"
```
...
python3 execution/memory_manager.py store \
  ...
  --tags outlook-calendar-automation workflow
```
