...
python3 execution/memory_manager.py auto --query "automation patterns and workflow configurations for Confluence Automation"
```
...
python3 execution/memory_manager.py store \
  ...
  --tags confluence-automation workflow
```
