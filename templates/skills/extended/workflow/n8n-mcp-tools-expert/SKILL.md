...
python3 execution/memory_manager.py auto --query "automation patterns and workflow configurations for N8N Mcp Tools Expert"
```
...
python3 execution/memory_manager.py store \
  ...
  --tags n8n-mcp-tools-expert workflow
```
