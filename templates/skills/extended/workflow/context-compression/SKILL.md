...
python3 execution/memory_manager.py auto --query "automation patterns and workflow configurations for Context Compression"
```
...
python3 execution/memory_manager.py store \
  ...
  --tags context-compression workflow
```
