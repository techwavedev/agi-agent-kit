...
python3 execution/memory_manager.py auto --query "automation patterns and workflow configurations for Freshservice Automation"
```
...
python3 execution/memory_manager.py store \
  ...
  --tags freshservice-automation workflow
```
