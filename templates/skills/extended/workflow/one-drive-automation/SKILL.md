...
python3 execution/memory_manager.py auto --query "automation patterns and workflow configurations for One Drive Automation"
```
...
python3 execution/memory_manager.py store \
  ...
  --tags one-drive-automation workflow
```
