...
python3 execution/memory_manager.py auto --query "automation patterns and workflow configurations for Notion Template Business"
```
...
python3 execution/memory_manager.py store \
  ...
  --tags notion-template-business workflow
```
