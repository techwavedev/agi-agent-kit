...
python3 execution/memory_manager.py auto --query "automation patterns and workflow configurations for Linkedin Automation"
```
...
python3 execution/memory_manager.py store \
  ...
  --tags linkedin-automation workflow
```
