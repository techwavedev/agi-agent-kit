...
python3 execution/memory_manager.py auto --query "automation patterns and workflow configurations for Freshdesk Automation"
```
...
python3 execution/memory_manager.py store \
  ...
  --tags freshdesk-automation workflow
```
