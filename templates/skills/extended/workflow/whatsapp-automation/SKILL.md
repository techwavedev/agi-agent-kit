...
python3 execution/memory_manager.py auto --query "automation patterns and workflow configurations for Whatsapp Automation"
```
...
python3 execution/memory_manager.py store \
  ...
  --tags whatsapp-automation workflow
```
