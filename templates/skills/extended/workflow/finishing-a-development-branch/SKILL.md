...
python3 execution/memory_manager.py auto --query "automation patterns and workflow configurations for Finishing A Development Branch"
```
...
python3 execution/memory_manager.py store \
  ...
  --tags finishing-a-development-branch workflow
```
