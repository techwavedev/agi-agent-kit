...
python3 execution/memory_manager.py auto --query "automation patterns and workflow configurations for Azure Communication Callautomation Java"
```
...
python3 execution/memory_manager.py store \
  ...
  --tags azure-communication-callautomation-java workflow
```
