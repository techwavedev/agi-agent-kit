...
python3 execution/memory_manager.py auto --query "automation patterns and workflow configurations for Bamboohr Automation"
```
...
python3 execution/memory_manager.py store \
  ...
  --tags bamboohr-automation workflow
```
