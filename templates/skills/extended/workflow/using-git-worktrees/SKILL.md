...
python3 execution/memory_manager.py auto --query "automation patterns and workflow configurations for Using Git Worktrees"
```
...
python3 execution/memory_manager.py store \
  ...
  --tags using-git-worktrees workflow
```
