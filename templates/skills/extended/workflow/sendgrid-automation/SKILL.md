...
python3 execution/memory_manager.py auto --query "automation patterns and workflow configurations for Sendgrid Automation"
```
...
python3 execution/memory_manager.py store \
  ...
  --tags sendgrid-automation workflow
```
