...
python3 execution/memory_manager.py auto --query "automation patterns and workflow configurations for Postmark Automation"
```
...
python3 execution/memory_manager.py store \
  ...
  --tags postmark-automation workflow
```
