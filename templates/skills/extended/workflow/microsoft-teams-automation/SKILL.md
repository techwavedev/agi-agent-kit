...
python3 execution/memory_manager.py auto --query "automation patterns and workflow configurations for Microsoft Teams Automation"
```
...
python3 execution/memory_manager.py store \
  ...
  --tags microsoft-teams-automation workflow
```
