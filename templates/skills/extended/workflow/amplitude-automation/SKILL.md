...
python3 execution/memory_manager.py auto --query "automation patterns and workflow configurations for Amplitude Automation"
```
...
python3 execution/memory_manager.py store \
  ...
  --tags amplitude-automation workflow
```
