...
python3 execution/memory_manager.py auto --query "automation patterns and workflow configurations for Helpdesk Automation"
```
...
python3 execution/memory_manager.py store \
  ...
  --tags helpdesk-automation workflow
```
