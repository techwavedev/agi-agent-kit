...
python3 execution/memory_manager.py auto --query "automation patterns and workflow configurations for Basecamp Automation"
```
...
python3 execution/memory_manager.py store \
  ...
  --tags basecamp-automation workflow
```
