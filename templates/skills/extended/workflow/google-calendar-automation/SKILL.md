...
python3 execution/memory_manager.py auto --query "automation patterns and workflow configurations for Google Calendar Automation"
```
...
python3 execution/memory_manager.py store \
  ...
  --tags google-calendar-automation workflow
```
