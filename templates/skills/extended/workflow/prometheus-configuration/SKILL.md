...
python3 execution/memory_manager.py auto --query "automation patterns and workflow configurations for Prometheus Configuration"
```
...
python3 execution/memory_manager.py store \
  ...
  --tags prometheus-configuration workflow
```
