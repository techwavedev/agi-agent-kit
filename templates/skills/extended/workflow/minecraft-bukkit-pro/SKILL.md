...
python3 execution/memory_manager.py auto --query "automation patterns and workflow configurations for Minecraft Bukkit Pro"
```
...
python3 execution/memory_manager.py store \
  ...
  --tags minecraft-bukkit-pro workflow
```
