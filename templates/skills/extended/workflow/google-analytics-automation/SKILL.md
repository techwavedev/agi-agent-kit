...
python3 execution/memory_manager.py auto --query "automation patterns and workflow configurations for Google Analytics Automation"
```
...
python3 execution/memory_manager.py store \
  ...
  --tags google-analytics-automation workflow
```
