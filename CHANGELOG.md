...
- `README.md` — Updated for v1.3.3: new tier descriptions, 8-platform table, categorized structure, community credits section
- `package.json` — Version bump to 1.3.3, added `THIRD-PARTY-LICENSES.md` to published files
