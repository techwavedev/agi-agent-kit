...
- **AGENTS.md** — Added Session Close Protocol section, `evaluate_skill.py` command reference, progressive disclosure enforcement, and Mermaid context compression examples.
